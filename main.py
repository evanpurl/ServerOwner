...
client = commands.Bot(command_prefix=".", case_insensitive=True, owner_id=int(os.environ.get('OWNERID')), intents=discord.Intents.all())
client.remove_command("help")

@client.event
async def on_ready():
    await client.tree.sync()
    await client.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name=f"over ServerOwner"))
